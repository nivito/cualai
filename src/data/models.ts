...
export const aiModels: AIModel[] = [
  ...
  // ── Anthropic (nuevos) ──
  {
    ...
    speedLabel: "Medio",
    intelligence: 5,
    strengths: ["#1 en leaderboard mundial (ELO 2002)", "Mejor en escritura de calidad", "Razonamiento complejo profundo", "200K contexto"],
