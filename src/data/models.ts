...
export const aiModels: AIModel[] = [
  ...
  // ── OpenAI (nuevos) ──
  {
    ...
    longDescription: "GPT-5.4 es la iteración más reciente de la serie GPT-5 de OpenAI, posicionado en el puesto #3 del leaderboard global con ELO de 1665 y 92.8% en MMLU. Ofrece 1 millón de tokens de contexto a un precio de $2.50/$15.00 por millón de tokens. Es multimodal, soporta herramientas avanzadas y es el modelo por defecto para usuarios premium de ChatGPT.",
    type: ["texto", "multimodal", "codigo", "razonamiento"],
    typeLabels: ["Texto", "Multimodal", "Código", "Razonamiento"],
    contextWindow: 1000000,
    contextWindowLabel: "1M tokens",
    ...
    speedLabel: "Rápido",
    intelligence: 5,
    strengths: ["Top 3 mundial (ELO 1665)", "1M tokens de contexto", "92.8% MMLU", "Precio competitivo para frontier"],
